---
name: clickhouse-io
description: Use when designing ClickHouse tables, MergeTree engines, materialized views, or analytical queries.
---
...
const bulkInsertOrders = async (orders: Order[]) => {
...
SELECT
    ...
    countIf(step = 'added_to_cart') AS clicked,
